...
def get_portfolio():
    ...
    url = "https://trade-api.vndirect.com.vn/accounts/v3/{}/portfolio".format(
        acc_id)
...
def get_stocks():
    ...
    url = "https://trade-api.vndirect.com.vn/accounts/v3/{}/stocks".format(
        acc_id)
...
def get_account_info():
    login_token = get_login_token()
    url = 'https://trade-bo-api.vndirect.com.vn/accounts/v3/{}/assets'.format(
        acc_id)
    headers = {
        'x-auth-token': login_token,
    }
